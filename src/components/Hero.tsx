		...
		<div className='relative h-screen w-full overflow-hidden'>
			...
			<div
				...
				style={{
					...
					filter: 'sepia(0.8) contrast(1.1) brightness(0.7)',
				}}
			/>
			...
			<div
				...
				style={{
					background:
						'linear-gradient(rgba(75, 38, 21, 0.4), rgba(75, 38, 21, 0.8))',
				}}
			/>
			...
			<div className='relative z-10 flex h-full w-full items-center justify-center'>
				<div className='container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8'>
					...
					>
						...
						<div
							className={`swiper-button-prev hero-swiper-button-prev -translate-y-1/2 absolute top-1/2 z-20 flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-white transition-all duration-300 focus-within:text-amber-500 hover:text-amber-500 focus:text-amber-500 active:text-amber-500 sm:h-12 sm:w-12 lg:h-16 lg:w-16 ${isRTL ? 'right-2 sm:right-4 md:right-6 lg:right-8' : 'left-2 sm:left-4 md:left-6 lg:left-8'}`}
						>
							<svg
								width='24'
								height='24'
                ...
                role='graphics-symbol img'
						...
						<div
							className={`swiper-button-next hero-swiper-button-next -translate-y-1/2 absolute top-1/2 z-20 flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-white transition-all duration-300 focus-within:text-amber-500 hover:text-amber-500 focus:text-amber-500 active:text-amber-500 sm:h-12 sm:w-12 lg:h-16 lg:w-16 ${isRTL ? 'left-2 sm:left-4 md:left-6 lg:left-8' : 'right-2 sm:right-4 md:right-6 lg:right-8'}`}
						>
							<svg
								width='24'
								height='24'
